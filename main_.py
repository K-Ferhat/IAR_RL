...
from policies import DDPG_Policy, BernoulliPolicy, NormalPolicy, SquashedGaussianPolicy, DiscretePolicy, PolicyWrapper
...
def study_pg(params) -> None:
    ...
    for i in range(len(study)):
        ...
        for j in range(params.nb_repet):
            ...
            plot_policy(policy, simu.env, True, simu.env_name, study[i], '_ante_', j, plot=True)
